...
public class BillCalculatorServiceImpl implements IBillCalculatorService {
	...
	@Override
	public double calculateCharges(Parcel parcel, String destination, boolean secondHalf)
			throws ParcelValidationException {
		...
		// Apply handle with care charge
		if (parcel.isFragile()) {
			parcelCharges = parcelCharges
					+ ((parcel.getEffectiveWeight() / 100) * PricingDetailsUtil.handleWithCareCharges);
		}
